...
<header class="header" style="display: flex; justify-content: space-between; align-items: center;">
    ...
    <!-- Dashboard Title (slightly moved right) -->
    <h1 class="page-title" style="margin-left: -200px;">Dashboard</h1>
    
    <!-- Profile Container (button fully to the right) -->
    <div class="profile-container">
        <div class="user-profile">
            <button class="dropdown-btn" onclick="toggleDropdown()">
                <img src="logo.png" class="profile-img" alt="User Profile" />
                <span class="profile-name">Olivia</span>
                <svg class="icon icon-purple" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
