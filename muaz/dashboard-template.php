...
var temperatureData = [22, 23, 21, 24, 25, 22];  // Example temperature values in °C
var humidityData = [60, 62, 58, 64, 65, 63];     // Example humidity values in %
...
var temperatureChart = new Chart(ctxTemp, {
    ...
    data: {
        ...
        datasets: [{
            label: 'Temperature (°C)',
            data: temperatureData, // Data points for temperature
...
var humidityChart = new Chart(ctxHum, {
    ...
    data: {
        ...
        datasets: [{
            label: 'Humidity (%)',
            data: humidityData, // Data points for humidity
            borderColor: 'rgb(54, 162, 235)', // Line color
            backgroundColor: 'rgba(54, 162, 235, 0.2)', // Background color for the line area
            fill: true // Fill area under the line
        }]
    },
    options: {
